...
export class SearchResults {
  ...
  loadData() {
    ...
    if (this.appService.searchDataLoaded) {
      ...
      // return Promise.all([
      //   this.dataService.loadAdjusterprep() //this.queryParams
      // ]).then(values => {
      ...
      //   console.log('arprep search results', adjusterprep, adjusterprep.length)
      //   return adjusterprep
      ...
      let adj = this.appService.currentSearchadj
      if (adj !== undefined) {
        return new Promise((resolve, reject) => {


          this.api.adjusterprepone(adj)
            .then((jsonRes) => {
      ...
      //       .then((jsonRes) => {
      //         this.origItems = jsonRes.data //[0];
      //         console.log(' this.origItems ', this.origItems)s
      //         adjusterprep = this.origItems
      //         resolve(adjusterprep);
      //         return adjusterprep
      //       });
